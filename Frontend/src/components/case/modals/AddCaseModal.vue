    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="addCaseModalLabel">新增案件</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <form @submit.prevent="submitForm">
            <div class="mb-3">
              <label for="caseName" class="form-label">案件名称</label>
              <input type="text" class="form-control" id="caseName" v-model="form.caseName" required>
            </div>
            <div class="mb-3">
              <label for="caseType" class="form-label">案件类型</label>
              <select class="form-select" id="caseType" v-model="form.caseType" required>
            ...
            <div class="mb-3">
              <label for="status" class="form-label">案件状态</label>
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                <label for="startDate" class="form-label">立案日期</label>
                <input type="date" class="form-control" id="startDate" v-model="form.startDate">
              </div>
              <div class="col-md-6 mb-3">
                <label for="endDate" class="form-label">结案日期</label>
